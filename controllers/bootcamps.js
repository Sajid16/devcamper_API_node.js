...
exports.getBootcamps = async (req, res, next) => {
  try {
    console.log(req.query); // getting params values
    // console.log(req.headers['host']); // getting headers values

    // reading params values and converting it to mongo query type
